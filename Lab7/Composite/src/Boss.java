...
/**
 * Boss node that contains subordinate employees
 * It is also a subclass of employee class.
 * If a boss runs out of employees the enumeration will be empty
 * Class also contains a list of employees of a manager
 */
