...
/**
 * Adaptation carried out if you know the name of the method which can be seen on the method dump
 * The name is set for the class and makes use of the setName method
 */
